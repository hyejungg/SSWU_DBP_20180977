...
<body>
    ...
    <form action ="emp_delete_process.php" method="POST" >
        ...
        <input type="text" name="emp_no" 
                value="<?= $row['emp_no']?>" palceholder="emp_no" readonly /><br >
        <label>birth_date:(0000-00-00) </label>
        <input type="text" name="birth_date" 
                value="<?= $row['birth_date']?>" palceholder="birth_date" readonly /><br >
        <label>first_name: </label>
        <input type="text" name="first_name" 
                value="<?= $row['first_name']?>" palceholder="first_name" readonly /><br >
        <label>last_name: </label>
        <input type="text" name="last_name" 
                value="<?= $row['last_name']?>" palceholder="last_name" readonly /><br >
        <label>gender:(M or F) </label>
        <input type="text" name="gender" 
                value="<?= $row['gender']?>" palceholder="gender" readonly /><br >
        <label>hire_date:(0000-00-00) </label>
        <input type="text" name="hire_date" 
                value="<?= $row['hire_date']?>" palceholder="hire_date" readonly /><br >
